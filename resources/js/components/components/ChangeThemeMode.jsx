...
const ChangeThemeMode = () => {
    ...
    }} className="relative mt-14 flex justify-center rounded-[20px] bg-gradient-to-br from-[#868CFF] via-[#432CF3] to-brand-500 pb-4">
      <div className="absolute -top-12 flex h-24 w-24 items-center justify-center rounded-full border-[4px] border-white bg-gradient-to-b from-[#868CFF] to-brand-500 dark:!border-navy-800 rotate-180">
        <svg
            className={"rotate-45"}
          width="41"
          height="41"
