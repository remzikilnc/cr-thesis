                    ...
                    {({
                        ...
                        <div className="mb-4">
                            ...
                            {(errors.password_confirmation && touched.password_confirmation) &&
                                <AlertDanger text={errors.password_confirmation}/>}
                        </div>
                        <DefaultButton className={"mt-2"} onClick={handleSubmit} type={"submit"}
                                       disabled={!isValid || isSubmitting}>Kayıt ol</DefaultButton>
                    </>)}
                </Formik>
                <div className="mt-3">
                    <span className="mb-10 flex-col flex">
                        <span className="font-thin text-black">Hesabın var mı?</span>
                        <NavLink className="mt-2 text-themePrimary underline"
                                 to={"/auth"}>Oturum aç.</NavLink>
                    </span>
                </div>
            </form>
        </Body>
