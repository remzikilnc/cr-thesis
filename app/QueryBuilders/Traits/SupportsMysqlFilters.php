<?php namespace App\QueryBuilders\Traits;
...
{
    public function applyMysqlFilters(CustomQueryBuilderFilters $filters, $query)
    {
     ...
     */
    private function filterByManyToManyRelation($query, BelongsToMany $relation, array $filter)
    {
